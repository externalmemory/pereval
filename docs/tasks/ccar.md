...
The top three non-reference rows (Kimi K3 0.033, hy3-free 0.036, deepseek-v4-flash-free 0.043) cluster just above the Vasicek reference and are statistically indistinguishable from one another. K3, the one frontier model here, is nominally best, and its coverage (0.90) dips slightly below target, dragged by one of the eight scenarios where it was overconfident (regret 0.12, coverage 0.68).
