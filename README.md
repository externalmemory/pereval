...
Scores are anchored against three references rather than one, and a run that produces no output is reported as unmeasured rather than scored. Both rules are set out in [docs/task-design.md](docs/task-design.md#anchoring-and-non-response).
